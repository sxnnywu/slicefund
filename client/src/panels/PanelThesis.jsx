...
export default function PanelThesis({ onAnalyze, loading, error, results, searches, progress, onCreateBasket }) {
  return (
    <>
      ...
      {results && <ResultsPanel data={results} onCreateBasket={onCreateBasket} />}
